...
public class SimpleSectionAdapter<T> extends BaseAdapter {
    ...
    private boolean mRegisterSection = false;
    ...
    public void setRegisterSectionizer(){
        mRegisterSection = true;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        case VIEW_TYPE_SECTION_HEADER:
            if(view == null) {
                ...
                sectionHolder.titleRightPrice =  (TextView) view.findViewById(R.id.tv_right_price);
                sectionHolder.titleDiscountPrice =  (TextView) view.findViewById(R.id.tv_discount_price);
        ...
        if(sectionHolder != null) {
            ...
            int index = sectionIndexForPosition(position);
            if(mRegisterSection == true) {
                sectionHolder.titleTextView.setText("상품"+(index+1));
            }
            else {
                sectionHolder.titleTextView.setText(sectionName);
            }

            sectionHolder.titleTextView.setTextColor(mContext.getResources().getColor(R.color.red));
            sectionHolder.titleRightPrice.setText("정상가");
            sectionHolder.titleDiscountPrice.setTextColor(mContext.getResources().getColor(R.color.red));

            if(mRegisterSection == true) {
                sectionHolder.titleDiscountPrice.setText("이벤트금액");
            }
            else {
                sectionHolder.titleDiscountPrice.setText("제휴가");
            }
    ...
    static class SectionHolder {
        ...
        public TextView titleRightPrice;
        public TextView titleDiscountPrice;
    }
    ...
    public int sectionIndexForPosition(int position) {
        int index = 0;
        Set<Entry<String, Integer>> entrySet = mSections.entrySet();
        for(Entry<String, Integer> entry : entrySet) {
            if(entry.getValue() == position) {
