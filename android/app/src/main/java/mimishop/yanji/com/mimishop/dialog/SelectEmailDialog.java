 ...
 */
public class SelectEmailDialog extends Dialog implements View.OnClickListener {

    public static final String TAG = "SelectEmailDialog";
    ...
    private String []m_arrEmail = {"naver.com",	"gmail.com",	"hanmail.com","nate.com"};
    private ArrayList<String> m_lstCategory = new ArrayList<String>();

    public SelectEmailDialog(LoginActivity context) {
        ...
        btnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(mContext.getClass() == LoginActivity.class) {
                    ((LoginActivity)mContext).emailSelected(m_arrEmail[selecteIdx]);
                }
    ...
    private void initData() {
        ...
        for(int i = 0; i < m_arrEmail.length; i++) {
            m_lstCategory.add(m_arrEmail[i]);
        }
        for(int i = 0; i < mExtraCount; i++) {
            m_lstCategory.add("");
        }
