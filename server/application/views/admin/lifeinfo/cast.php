<div class="container" xmlns="http://www.w3.org/1999/html" id="root" xmlns="http://www.w3.org/1999/html">
    <div class="row">
        <div class="col-md-6">
			...
			<div  class="col-md-12" align="right">
            	<button type="button" class="btn btn-default" onclick="MoveUp(true)">맨 위로</button>
            	<button type="button" class="btn btn-default" onclick="MoveDown(true)">맨 아래로</button>				
            </div>
            ...
            <button type="button" class="btn btn-default" onclick="MoveUp(false)">위로</button>
            <button type="button" class="btn btn-default" onclick="MoveDown(false)">아래로</button>
        </div>
