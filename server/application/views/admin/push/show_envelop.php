...
<div class="row">
    <div>
        <table class="table table-bordered" style="margin: 5px;">
            ...
            <tr>
                ...
                <td><?php echo $gcmInfo['gcmlogTitle'];?></td>
            </tr>

            <tr>
                <td class="base-table-header"><label>본문내용 </label></td>
                <td><?php echo $gcmInfo['gcmlogContent'];?></td>
            </tr>
    ...
    <div class="row" style="text-align: center;margin: 5px;">
        <button type="button" class="btn btn-default" onclick="removePush(<?php echo $gcmInfo['id']?>)"/> 삭제</button>
        <button type="button" class="btn btn-default" onclick="modifyEnvelop(<?php echo $gcmInfo['id']?>)"/> 수정</button>
    </div>
...
<script>
    ...
    function modifyEnvelop(idx) {
        var readed = document.getElementById("readed").getAttribute("value");
        ...
        window.open(getBaseURL()+'/push/update_envelop?id='+idx, '쪽지수정', 'width=640,height=320');
    }
